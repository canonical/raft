 ...
 * static arrays, so they can be easly referenced in other static declarations
 ...
 *
 * Each test file must declare one and only one test module. */
...
#define TEST_CASE__ADD_TO_MODULE(C, PARAMS)                             \
    ...
    {                                                                   \
        ...
        TEST_CASE__SET_IN_ARRAY(tests, n, "/" #C, test_##C, NULL, NULL, \
                                PARAMS);                                \
        _module_tests_n = n + 1;                                        \
    }
...
#define TEST_CASE__ADD_TO_GROUP(S, G, C, PARAMS)                            \
    __attribute__((constructor)) static void _##S##_##G##_tests_##C##_init( \
        void)                                                               \
    {                                                                       \
