...
static int raft_io_stub__bootstrap(struct raft_io *io,
...
static int raft_io_stub__append(struct raft_io *io,
...
static int raft_io_stub__truncate(struct raft_io *io, raft_index index)
{
    struct raft_io_stub *s;
    size_t n;
